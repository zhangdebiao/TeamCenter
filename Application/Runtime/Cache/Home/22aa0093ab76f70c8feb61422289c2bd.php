...
<title>资源共享 - <?php echo C('SITE_TITLE');?></title>
<div class="container">
<div class="row">
	<div class="col-md-9">
...
<center>
  <!-- <button class="btn btn-primary" data-toggle="modal" data-target="#create">创建资源类</button> -->
  <button class="btn btn-primary" data-toggle="modal" data-target="#create">分享新资源</button>
</center>
