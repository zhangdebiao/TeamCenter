...
<!--
<link href="/TeamCenter/Public/css/settings.css" rel="stylesheet" type="text/css" />
<link href="/TeamCenter/Public/css/settings_jcrop.css" rel="stylesheet" type="text/css" />
<script src="/TeamCenter/Public/js/settings_jquery.uploadify.min.js" type="text/javascript"></script>
<script src="/TeamCenter/Public/js/settings_jcrop.js" type="text/javascript"></script>
<script type="text/javascript">
        $(function() {
          $("#user-pic").uploadify({
            'swf' : '/TeamCenter/Public/js/settings_uploadify.swf',
            'uploader' : '/TeamCenter/Home/User/settings.html',
            'width' : '200',
            'height' : '200',
            'buttonText' : '上传头像',
            'fileTypeExts' : '*.jpg;',
            ...
            $('#save-pic').click(function() {
                if ($('#preview-hidden').html() == '') {
                  ...
                  var resdata;
                    $.ajax({
                      type:'POST',
                        url: "/TeamCenter/Home/User/settings.html/?action=jcrop",
                        data: {'crop': CutJson},
