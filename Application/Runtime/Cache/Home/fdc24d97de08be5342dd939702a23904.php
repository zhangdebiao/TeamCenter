...
<title>组成成员 - <?php echo C('SITE_TITLE');?></title>
<div class="container">
<div class="col-md-8">
...
<table class="table table-hover">
      ...
      <?php if(is_array($member)): $i = 0; $__LIST__ = $member;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
          ...
          <td><a href="<?php echo u('../Home/User/people/'.$vo['uid']);?>"><?php echo ($vo['username']); ?></a></td>
          <td><?php echo ($vo['admin']?'管理员':'会员'); ?></td>
...
<div class="col-md-4" id="space_height"></div>
</div><!--container-->
