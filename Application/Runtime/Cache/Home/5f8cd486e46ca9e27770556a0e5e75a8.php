...
<div class="panel panel-default">
  ...
  <div class="text-right"><a href="/TeamCenter/Home/User/people/<?php echo ($value["uid"]); ?>" target="_blank"><?php echo getUsername($value['uid']);?></a> 于 <?php echo ($value["time"]); ?> 发布于 <b>
  <?php if($value['class_id'] == 1): ?>社团公告
  <?php elseif($value['class_id'] == 2): ?>项目公告：<a href="/TeamCenter/Home/Project/<?php echo ($value['project_id']); ?>" target="_BLANK"><?php echo getProjectname($value['project_id']);?></a><?php endif; ?>
  </b>
